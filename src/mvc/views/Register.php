        ...
        <div class="form-value">
            <form method="POST" action="">
                ...
                <div class="inputbox">
                    ...
                    <input value="" name="name" class="input" type="text" required>
                    <label for="">Tên người dùng</label>
                </div>
                <div class="inputbox">
                    <ion-icon name="mail-outline"></ion-icon>
                    <input value="" name="email" class="input" type="text" required>
                ...
                <div class="inputbox">
                    <ion-icon name="lock-closed-outline"></ion-icon>
                    <input name="rePassword" class="input" type="password" required>
                ...
                <button class="custom-btn" type="submit">Đăng ký</button>
                <div class="register">
