    ...
    <div class="body-container">
        <div class="header-container">
            ...
            <div class="function_place">
                ...
                <button id="btn-excel" class="btn-outline content-type-normal">
        ...
        <div class="transition-place">
            <div class="item-choosing-block">
                <p class="all-user" style="margin-bottom: 12px !important">
                    Tất cả người dùng
                </p>
                <div class="divider-mini"></div>
            </div>
            <div class="item-choosing-block">
                <p class="customer" style="margin-bottom: 12px !important">
                    Khách hàng
                </p>
            </div>
            <div class="item-choosing-block">
                <p class="manager" style="margin-bottom: 12px !important">Quản lý</p>
            </div>
            <div class="item-choosing-block">
                        ...
                        <div class="container-fluid">
                            <div class="row gy-4 gx-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control address" aria-label="Username" aria-describedby="addon-wrapping" />
                                </div>
                                <div class="col-6"></div>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="row gy-4 gx-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control id" aria-label="Username" aria-describedby="addon-wrapping" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title">Tên</span>
                                    <input type="text" class="form-control first-name" aria-label="Username" aria-describedby="addon-wrapping" />
                                ...
                                <div class="col-6">
                                    <span class="form-title"> Email </span>
                                    <input type="email" class="form-control email" aria-label="email" aria-describedby="addon-wrapping" disabled />
                                </div>
                                ...
                                <div class="col-6">
                                    <span class="form-title"> Mật khẩu </span>
                                    <input type="password" class="form-control password" aria-label="Username" aria-describedby="addon-wrapping" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Địa chỉ </span>
                                    <input type="text" class="form-control address" aria-label="Username" aria-describedby="addon-wrapping" />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id='btn-delete-user-modal'>Xóa</button>
                </div>

            </div>
        </div>
    </div>
    <script type="module" src="../../public/js/admin/user-control.js"></script>
</body>
