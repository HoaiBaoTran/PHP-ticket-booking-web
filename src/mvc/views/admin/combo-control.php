...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/admin/combo-control/style.css" />
</head>
...
<body>
    ...
    <div class="body-container">
        <div class="header-container">
            <div class="title-place">
                <h1 class="title-heading">Danh sách Combo</h1>
            </div>
        ...
        <div class="search-place">
            ...
            " />
                <input id='search-combo-by-id' type="search" class="form-control rounded" placeholder="Tìm kiếm theo id" aria-label="Search" aria-describedby="search-addon" />
            </div>
        ...
        <div class="transition-place">
            <div class="item-choosing-block">
                <p class="all-combo" style="margin-bottom: 12px !important">
                    Tất cả Combo
                </p>
    ...
    <div class="sidebar-container">
        ...
        <a href="/admin/combo">
            <div class="item-container">
                ...
                <p class="item-description active">Combo</p>
            </div>
        </a>
    ...
    <!-- Add Modal -->
    <div class="modal fade" id="ModalAddUser" tabindex="-1" aria-labelledby="ModalAddUserLable" aria-hidden="true">
                    ...
                    <div class="input-group flex-nowrap">
                        <form class="container-fluid" action="#" method="post" enctype="multipart/form-data">
                            <div class="row gy-3 gx-5">
                                <div class="col-6">
                                    <span class="form-title"> Tên Combo </span>
                                    <input type="text" class="form-control" aria-label="Name" aria-describedby="addon-wrapping" id="Name" name="Name" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Giá </span>
                                    <input type="text" class="form-control" aria-label="Price" aria-describedby="addon-wrapping" id="Price" name="Price" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Ảnh </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-control" aria-label="status" aria-describedby="addon-wrapping" name="status" id="status">
                ...
                <div class="modal-body">
                    <div class="input-group flex-nowrap">
                        <form class="container-fluid" action="#" method="post" enctype="multipart/form-data">
                            <div class="row gy-3 gx-5">
                                <div class="col-6">
                                    <span class="form-title"> Mã Combo </span>
                                    <input type="text" class="form-control" aria-label="ItemID" aria-describedby="addon-wrapping" name="ItemID" id="ItemID" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Tên Combo </span>
                                    <input type="text" class="form-control" aria-label="Name" aria-describedby="addon-wrapping" id="Name" name="Name" />
                                ...
                                <div class="col-6">
                                    <span class="form-title"> Ảnh </span>
                                    <input type="text" class="form-control" aria-label="image" aria-describedby="addon-wrapping" id="image" multiple name="Image[]" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Trạng thái </span>
                                    <select class="form-control" aria-label="status" aria-describedby="addon-wrapping" name="status" id="status">
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="ModalDeleteCombo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id='btn-delete-combo-modal'>Xóa</button>
                </div>
            </div>
        </div>
    </div>
    <script type="module" src="../../public/js/admin/combo-control.js"></script>
</body>
