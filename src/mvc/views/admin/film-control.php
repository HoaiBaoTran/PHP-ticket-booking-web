...
<body>
    ...
    <div class="body-container">
        <div class="header-container">
            <div class="title-place">
                <h1 class="title-heading">Danh sách phim</h1>
            </div>
        ...
        <div class="search-place">
            ...
            <select id="select-genre" class="form-select">
                <option selected value="">Thể loại</option>
            </select>
            <select id="select-studio" class="form-select">
                <option selected value="">Studio</option>
            </select>
        ...
        <div class="transition-place">
            <div class="item-choosing-block">
                <p class="all-film" style="margin-bottom: 12px !important">
                    Tất cả phim
                </p>
                <div class="divider-mini"></div>
            </div>
            <div class="item-choosing-block">
                <p class="hot-film" style="margin-bottom: 12px !important">
                    Phim hot
                </p>
                <div class="divider-mini hidden"></div>
            </div>
            <div class="item-choosing-block">
                <p class="premiere-film" style="margin-bottom: 12px !important">
                    Phim đang chiếu
                </p>
                <div class="divider-mini hidden"></div>
            </div>
            <div class="item-choosing-block">
                <p class="upcoming-film" style="margin-bottom: 12px !important">
                    Phim sắp chiếu
                </p>
                <div class="divider-mini hidden"></div>
            </div>
    ...
    <!-- Modal Add-->
    <div class="modal fade" id="ModalAddUser" tabindex="-1" aria-labelledby="ModalEditUserLable" aria-hidden="true">
                        ...
                        <form class="container-fluid" action="#" method="post" enctype="multipart/form-data">
                            <div class="row gy-3 gx-5">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" aria-label="ID_Film" aria-describedby="addon-wrapping" name="MovieName" id="name" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Thời lượng </span>
                                    <input type="text" class="form-control" aria-label="Time" aria-describedby="addon-wrapping" id="time" name="Time" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Ngôn ngữ </span>
                                    <select class="form-select" aria-label="Language" aria-describedby="addon-wrapping" id="language" name="LanguageID">
                                        <option value="" selected>Chọn ngôn ngữ</option>
                                    </select>
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Studio </span>
                                    <select class="form-select" aria-label="studio" aria-describedby="addon-wrapping" id="studio" name="StudioID">
                                        <option value="" selected>Chọn studio</option>
                                    </select>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" aria-label="Description" aria-describedby="addon-wrapping" id="story" name="Story" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Khởi chiếu </span>
                                    <input type="date" class="form-control" aria-label="datefilm" aria-describedby="addon-wrapping" id="premiere" name="Premiere" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Năm </span>
                                    <input type="text" class="form-control" aria-label="datefilm" aria-describedby="addon-wrapping" id="year" />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Link Trailer </span>
                                    <input type="text" class="form-control" aria-label="Trailer_Link" aria-describedby="addon-wrapping" id="trailer" name="URLTrailer" />
                                </div>
