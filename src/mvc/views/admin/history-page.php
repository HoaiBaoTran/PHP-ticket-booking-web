...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/admin/history-page/style.css" />
</head>
...
<body>
    ...
    <div class="body-container">
        <div class="header-container">
            <div class="title-place">
                <h1 class="title-heading">Lịch sử giao dịch</h1>
            </div>
        ...
        <div class="search-place">
            ...
            <button class="btn-main content-type-normal ms-auto" id="btn-search">
                Tìm kiếm
            </button>
        </div>
        <div class="divider-container"></div>
        <div class="transition-place">
            <div class="item-choosing-block">
                <p class="all-ticket" style="margin-bottom: 12px !important">
                    Tất cả giao dịch
                </p>
    ...
    <div class="sidebar-container">
        ...
        <a href="/admin/history">
            <div class="item-container">
                ...
                <p class="item-description active">Lịch sử đặt vé</p>
            </div>
        </a>
        <a href="/admin/time">
            <div class="item-container">
                        ...
                        <form class="container-fluid" action="#" method="post" enctype="multipart/form-data">
                            <div class="row gy-3 gx-5">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" aria-label="ID_Film" aria-describedby="addon-wrapping" id="id" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Số vé đặt </span>
                                    <input type="text" class="form-control" aria-label="ID_Film" aria-describedby="addon-wrapping" id="number" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Tổng tiền </span>
                                    <input type="text" class="form-control" aria-label="Time" aria-describedby="addon-wrapping" id="total" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Thời gian giao dịch </span>
                                    <input type="text" class="form-control" aria-label="Producer_name" aria-describedby="addon-wrapping" id="time" disabled />
                                </div>

                                <div class="col-6">
                                    <span class="form-title">Voucher</span>
                                    <input type="text" class="form-control" aria-label="age" aria-describedby="addon-wrapping" id="voucher" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Mã khách hàng </span>
                                    <input type="text" class="form-control" aria-label="Description" aria-describedby="addon-wrapping" id="customerID" disabled />
                                </div>
                                <div class="col-6">
                                    <span class="form-title"> Trạng thái </span>
                                    <select class="form-control" aria-label="datefilm" aria-describedby="addon-wrapping" id="status">
    ...
    <script src="../../public/js/admib/history-page.js" type="module"></script>
</body>
